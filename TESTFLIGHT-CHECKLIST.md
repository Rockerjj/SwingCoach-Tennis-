...
- [ ] Open `Tennique.xcodeproj` in Xcode
...
- [ ] Select the `Tennique.storekit` configuration for StoreKit testing in Xcode scheme
...
- [ ] Set Privacy Policy URL: `https://tennique.com/privacy`
